...
public class Market {
    ...
    public List<Trade> placeSellOrder(Order order) {
        if (order != null && !order.isBuy()) {
            //System.out.println("Passed this step");
                ...
                if (buyBook != null && sellBook != null) {
                    ...
                    if (!buyBook.isEmpty()) {
                        ...
                        if (buyBook.size() > 0) {
                            ...
                            /*for (int k = 0; k < buyBookStored.size(); k++) {
                                System.out.println(buyBookStored.get(k));
                            }*/
                            //System.out.println(buyBookStored.size());
                            //System.out.println(positionOfMaxPrice);
                            ...
                            while (buyBookStored.size() > 0 && order.getAmount() > 0) {
                                ...
                                if (maxPrice < order.getPrice()) {
                                    ...
                                    //System.out.println(newAmountEntry);
                                    ...
                                    if (newAmountEntry > order.getAmount()) {
                                        ...
                                        order.adjustAmount(amountToRemove);
                                        //System.out.println(seller.getAmountStored(newProductEntry));
                                        //System.out.println(order.getAmount());
                                        String buyerID = buyer.getID();
                            ...
                            /*for (int i = 0; i < sellBook.size(); i++) {
                                System.out.println(sellBook.get(i));
                            }*/
            ...
            if (buyBook != null && sellBook != null) {
                ...
                if (!sellBook.isEmpty()) {
                    ...
                    if (sellBook.size() > 0) {
                        ...
                        //double minNum = sellBookStored.get(0).getPrice();
                        ...
                        /*for (int i = 0; i < buyBook.size(); i++) {
                            System.out.println(buyBook.get(i));
                        }*/
